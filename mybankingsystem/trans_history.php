...
<head>
    ...
    <style>
    body{
      background-image: url(2559892.jpg);
              ...
              <div class="tm-col-left">
                  <div class="tm-site-header media">
                      ...
                      <div class="media-body">
                          <h1 class="tm-sitename text-uppercase">BANK OF INDIA</h1>
...
<table>
        ...
        <tbody>
            ...
            $username = "epiz_29196500";
            $conn = new mysqli($servername, $username,"",''epiz_29196500_bank');
